...
namespace sdds
{
    ...
    TennisLog::TennisLog(const TennisLog &Tlog)
    {
        ...
        {
            TennisMatch match(Tlog.tennis_matches[i].t_tournament_id, Tlog.tennis_matches[i].t_tournament_name, Tlog.tennis_matches[i].t_match_id, Tlog.tennis_matches[i].t_winner, Tlog.tennis_matches[i].t_loser);
    ...
    TennisLog TennisLog::findMatches(const char *name_of_player) const
    {
        ...
        for (size_t x = 0; x < m_num_of_matches; x++)
        {
            ...
            {
                TennisMatch match(tennis_matches[x].t_tournament_id, tennis_matches[x].t_tournament_name, tennis_matches[x].t_match_id, tennis_matches[x].t_winner, tennis_matches[x].t_loser);
