...
int main()
{
    Card C[7] = { Card("Hearts", 13), Card("Clubs", 7), Card("Spades", 5),
                 ...
                 Card("Diamonds", 12) };
    Book B[6] = { Book(23456, "Dune","Frank Herbert",9.99),
                    Book(45678, "Foundation", "Issac Asimov", 19.99), 
                    Book(56789, "The Lord of the Rings","J.R.R. Tolkien", 7.99),
                    Book(67890, "Frankenstein", "Mary Shelly", 4.99), 
                    Book(34567, "The Martian", "Andy Weir",10.50),
                    Book(12345, "The Hitchhiker's Guide to the Galaxy", "Douglas Adams",12.99)};
