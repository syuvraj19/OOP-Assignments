...
namespace sdds {
   ...
   const int  MIN_YEAR = 1500; // an integer between the year 1500 till today

   class Date { //A class the encapsulates year, and month and day values for Date stamp, comparison and Date IO purposes.
